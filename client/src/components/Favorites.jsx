...
const Favorites = () => {
    ...
    const handleDelete = (e) => {
        ...
        axios.get("http://localhost:8000/favorites/delete/" + user.userORtutor_id + "/" + e, {
    ...
    const handleSchedule = (tutorID, e) => {
                  ...
                  <Col xs="4">
                    ...
                    >
                      ...
                      <Card.Body>
                        ...
                        &ensp;
                        <Button onClick={e => handleDelete(tutor.tutor_id)} variant="primary">Remove from favorites</Button>
                      </Card.Body>
                    </Card>
                  </Col>
              ))
